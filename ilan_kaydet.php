...
li a:hover {
    ...
    <main>
        <?php
        // İlanın başarıyla kaydedildiğini kontrol etmek için post verisini kontrol edin
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            // İlan verilerini alın
            $baslik = $_POST['baslik'];
            $aciklama = $_POST['aciklama'];
            $sirket = $_POST['sirket'];
            $sehir = $_POST['sehir'];
            $maas = $_POST['maas'];
            $basvuru_sonu = $_POST['basvuru_sonu'];

            // İlanı veritabanına kaydedin veya işleyin
            // ...

            // Ödeme yapma formunu gösterin

            ?>
            <form action="odeme_kaydet.php" method="post">
            <div class="modal">
<form class="form">
...
/* Reset input number styles */
            ...
            // İlan kaydedilmediyse, hata mesajını görüntüleyin veya yönlendirin
            echo '<h1>Hata! İlan kaydedilmedi.</h1>';
        }
        ?>
    </main>
